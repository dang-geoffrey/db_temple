...
class classMySql
{
	...
	-------------------------------------------------------------------------------------------------------------------*/		
	public function __construct($databseName='baagglpayment',$host = "localhost",$user = "root", $password = "") 
	{
		/*----------------------------------
	...
	public function query($query)
	{
		...
		{
			print "<br><b>Error:</b><pre>$query</pre><br>";
			throw new Exception("<b>Error:</b>\n<br> <pre>$query</pre><br> " . mysql_error());
		}
	...
	Method Name	:	query
	Param		:	$query as Databse Query	
	Return		:	auto increase id - Exception if any
	Description	:	Function to execute the given query.
	----------------------------------------------------------------------------------------------------------------------*/	
	...
	public function selectQuery($query)
	{
		...
		if(!$this->resultSet=@mysql_query($query,$this->connectionHandle))
		{
			print "<br><b>Error: </b><br><pre>$query</pre><br>";
			throw new Exception("<b>Error:</b>\n " . mysql_error());
		}
		else 
	...
	/*--------------------------------------------------------------------------------------------------------------------------------
	Method Name	:	insertRowSql
	Param		:	$query: sql statement
	Return		:	id or Exception if any
	Description	:	Function to execute the insert query. */
	
	public function insertRowSql($query)
	{
	...
	function sendEmailHtml($senderName, $from, $to, $subject, $message, $bcc='', $cc='')
	{
		...
		// Mail it
		    ...
		    { 
		      print ("An error occurred while sending the e-mail! - Subject: $subject"); 
		      return 0;
		    } 	
